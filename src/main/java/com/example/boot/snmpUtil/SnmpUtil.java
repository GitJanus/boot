package com.example.boot.snmpUtil;
...
public class SnmpUtil {
    ...
    private static String ipAddress = "udp:192.168.153.128/";
    ...
    public static void initSnmp() throws IOException {
        ...
        UdpAddress updAddr = (UdpAddress) GenericAddress.parse("udp:192.168.153.128/161");
